<template>
  <div class="MuTop">
    <nav class='nav'>
      ...
      <ul id='ul'>
        <router-link to='/Merchant'><li><a href="javascript:;">首页</a></li></router-link>
        <router-link to='/Procontract'><li><a href="javascript:;">我的合同</a></li></router-link>
        <router-link to='/BuyProduct'><li><a href="javascript:;">我的模板</a></li></router-link>
        <router-link to='/BuyProduct'><li><a href="javascript:;">签约室</a></li></router-link>
        <li @click="dialogVisible" style='color:#fff;cursor:pointer'>版本</li>
      </ul>
      <ol class='btns'>
        <li><router-link to='/BuyProduct'><a href="javascript:;">模板发起</a></router-link></li>
        <li>
        ...
        <li style="margin-left:30px;"><router-link to='/Account'><img src="../../../static/images/setup.png" alt=""><a href="javascript:;">我的账户</a></router-link></li>
      </ol>
      <div id='update'>
      </div>
    </nav>
    <div id="dilog">
      <div class='box'>
        <div class='box-container'>
          ...
          <a href="javascript:;" id='close' @click='closes'>X</a>
        </div>
      </div>
    </div>
  </div>
