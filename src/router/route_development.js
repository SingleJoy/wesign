...
import EnterprisePayment from '../components/EnterpriseCertificate/EnterprisePayment/EnterprisePayment.vue'     
...
import OrderList from '@/components/BatchImport/OrderList/OrderList.vue'
import ImportData from '@/components/BatchImport/ImportData/ImportData.vue'
import BatchContractList from '@/components/BatchImport/BatchContractList/BatchContractList.vue'
import SingleSigning from '@/components/BatchImport/SingleSign/SingleSigning.vue'
import SingleSigned from '@/components/BatchImport/SingleSign/SingleSigned.vue'
import CreateContract from '@/components/BatchImport/CreateContract/CreateContract.vue'
import BatchSigning from '@/components/BatchImport/BatchSign/BatchSigning.vue'
import BatchSigned from '@/components/BatchImport/BatchSign/BatchSigned.vue'

Vue.use(Router)

export const router_dev = new Router({
//   mode: "history",
  routes: [{
      path: '/',
      name: 'User',
...
router_dev.beforeEach((to, from, next) => {
