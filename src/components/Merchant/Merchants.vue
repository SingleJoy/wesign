<template>
    <div class='Merchants'>
        ...
        <div v-show="topTip" class="main_tips" id="main_tips">
        ...
        <div class="dialogbg" v-if="$store.state.topTipDialog">
            <div class="warn-info">
                <a  href="javascript:void(0);"  class="close-warn" @click="cancelTipDialog">X</a>
            </div>
            <div class="goEnterpriseCertificate" @click="goEnterpriseCertificate">去实名</div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            cancelTipDialog(){
                this.$store.dispatch('topTipDialog',{topTipDialog:false});
            },
            jumper (item,index) {
...
<<<<<<< HEAD
            ...
            goEnterpriseCertificate(){
                this.$router.push('/EnterpriseCertificate')
            }
        },
        created() {
            console.log(this.$store.state.topTipDialog)
