<!--<template>-->
  <!--<div class='Completions'>-->
    ...
    <!--</div>-->
    <!--<div class='container' >-->
      <!--&lt;!&ndash;<h2 class='title1' style='text-align:left;border-top: 1px solid #ddd;padding: 20px 0 0 20px;'>&ndash;&gt;-->
        <!--&lt;!&ndash;<img src="../../../../static/images/Confirmation/Enterprise/title.jpg" alt="">&ndash;&gt;-->
      <!--&lt;!&ndash;</h2>&ndash;&gt;-->
      <!--<div class='success'>-->
        <!--<p>-->
          <!--<img src="../../../../static/images/contract-success.png" alt="">-->
        <!--</p>-->
        <!--<p>恭喜，已完成实名认证！</p>-->
      <!--</div>-->
      <!--<div class='centerOne'>-->
        <!--<div class='center' style="padding-top: 20px;">-->
          ...
          <!--<div style='clear:both;text-align:center;'>-->
              <!--<router-link to='/'><el-button type="primary" style='width:330px;margin-top:35px;background-color: #4091fb;'>返回登录页</el-button></router-link>-->
            <!--</div>-->
        <!--</div>-->
      <!--</div>-->
    <!--</div>-->
