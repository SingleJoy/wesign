  ...
  <div>
    ...
    <div class='Payments'>
      ...
      <div class='productes'>
        ...
        <div class='success'>
          <p><img src="../../../../static/images/Confirmation/Payment/pic.jpg" alt=""></p>
          <p>恭喜，企业基本信息上传成功！</p>
        </div>
        <div class='centerOne'>
          <div class='successInfo' style='margin-top:0;'>
            <p class="hint">请在下方完善企业对公账户信息，众签将向您的账户进行一笔小额打款操作（0.01~0.99元之间）</p>
            <p class="cue" style="padding-left:160px;">由于银行业务原因，到账时间可能为2~24小时，请耐心等待</p>
            <div style="margin: 0 auto 50px auto;width: 540px;">
              <div class='firsrCheck'>
                <span>企业开户名称</span>
                <el-input
                  :maxlength='200'
              ...
              <p id='errorInfo'></p>
              <el-button type="primary" style='width:330px;height:40px;margin-bottom:20px;margin-left: 172px;margin-top: 30px;' @click="submitPayment">提交</el-button>
              <br/>
              <br/>
    ...
    methods:{
      ...
      submitPayment(){
        ...
        this.$http.post(process.env.API_HOST+'v1.4/tenant/'+interfaceCode+'/bank',
          {
            'to_acc_name':this.enterpriseOpenName,      //收款人银行名称
            'to_pro_name':this.province,                //开户行省名
            'to_city_name':this.city,                   //开户行市名
...
<style>
  @import "../../../styles/Confirmation/Payment/Payment.css";
