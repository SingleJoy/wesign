                ...
                <div class="single-list" v-if="(singleTemplateLength)||(batchTemplateLength)">
                  ...
                  <template>
                    <el-checkbox-group v-model="singleTemplate" >
                      <el-checkbox v-for="item in single" :label="item.templateNo" :key="item.templateNo" :checked="item.flag">{{item.templateName}}</el-checkbox>
                    </el-checkbox-group>
                  </template>
                ...
                <div class="batch-list" v-if="(singleTemplateLength)||(batchTemplateLength)">
                  ...
                  <template>
                    <el-checkbox-group v-model="batchTemplate" >
                      <el-checkbox v-for="item in batch" :label="item.templateNo"   :key="item.templateNo" :checked="item.flag">{{item.templateName}}</el-checkbox>
                    </el-checkbox-group>
                  </template>
