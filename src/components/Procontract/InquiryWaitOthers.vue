<template>
  <div class="InquiryWaitOthers" style="margin-top: 20px;">
   <div class='title' style="border:none;text-align:left;padding-left:20px;">
      ...
      <el-button type="primary" icon="el-icon-search" @click='contractInquiryWaitOthers' style='margin-left:50px;'></el-button>
    </div>
    <div class='table'>
