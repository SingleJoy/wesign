    ...
    <div class='step' style="width:720px;">
       ...
       <div class='signing' style="margin-top:40px;">   <!--签署合同开始-->
          ...
          <div class='sign_center' ref="rightWrapper" id="div1"> <!-- 渲染合同页面 -->
              ...
              <li v-for="(item, index) in imgList" :key="index" class="contractImg-hook" style="height:842px;">
                <!-- <img :src="[`${this.baseURL.BASE_URL}`+'/v1/tenant/contract/img?contractUrl='+item]" alt="" style='width: 100%;height:100%;' id='signImg'> -->
                <img :src="['http://test.wesign.zqsign.com/restapi/wesign/v1/tenant/contract/img?contractUrl='+item]" alt="" style='width: 100%;height:844px;' id='signImg'>
              </li>
            </ul>
          </div>
