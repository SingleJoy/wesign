<template>
  <div>
    ...
    <div class='TemplatePoses' style="margin-top: 100px;">
...
<script>
  ...
  import {signerpositions} from '@/api/template'
  import {getContractDetails,contractimgs} from '@/api/detail'
  ...
  export default {
    ...
    data () {
      return {
        ...
        needSign:sessionStorage.getItem("needSign"),
    ...
    methods:{
      ...
      nextStepFit(){
        ...
        if( arr.indexOf("0") == -1){
          ...
          let params={"signerpositions":param};
          signerpositions(this.interfaceCode,this.contractNo,params).then(res=> {
  ...
  created () {
    ...
    contractimgs(this.interfaceCode,this.contractNo,time).then(res=> {
