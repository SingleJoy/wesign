          ...
          <!--<div class='container'>-->
            ...
            <!--<div class="header-title-3">-->
                ...
                <!--<div class='left'>-->
                  <!--<div class="upload_warp">-->
                    <!--<div class="upload_warp_left" @click="fileClick" style="font-size:0;border:none">-->
                      ...
                      <!--&lt;!&ndash; <img src="../../../../../static/images/001.png" alt=""> &ndash;&gt;-->
                    <!--</div>-->
                  <!--</div>-->
                ...
                <!--<div class='right'>-->
                  <!--<div class="upload_warp">-->
                    <!--<div class="upload_warp_left" @click="imageClick" style="font-size:0;border:none">-->
                      ...
                      <!--&lt;!&ndash; <img src="../../../../../static/images/003.png" alt=""> &ndash;&gt;-->
                    <!--</div>-->
                  <!--</div>-->
                  <!--<div class="upload_warp_text">-->
              ...
              <!--<div class='btns' style='clear:both'>-->
                <!--&lt;!&ndash; <router-link to='/Home'><el-button type="primary" style='width:200px'>返回首页</el-button></router-link> &ndash;&gt;-->
