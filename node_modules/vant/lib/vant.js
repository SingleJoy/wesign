...
/* harmony default export */ var field = (create({
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('cell', { class: _vm.b({
      ...
      }), attrs: { "icon": _vm.leftIcon, "title": _vm.label, "center": _vm.center, "border": _vm.border, "required": _vm.required } }, [_vm._t("label", null, { slot: "title" }), _vm.type === 'textarea' ? _c('textarea', _vm._g(_vm._b({ ref: "textarea", class: _vm.b('control'), domProps: { "value": _vm.value } }, 'textarea', _vm.$attrs, false), _vm.listeners)) : _c('input', _vm._g(_vm._b({ class: _vm.b('control'), attrs: { "type": _vm.type }, domProps: { "value": _vm.value } }, 'input', _vm.$attrs, false), _vm.listeners)), _vm.errorMessage ? _c('div', { class: _vm.b('error-message'), domProps: { "textContent": _vm._s(_vm.errorMessage) } }) : _vm._e(), _vm.showIcon ? _c('div', { class: _vm.b('icon'), on: { "touchstart": function touchstart($event) {
